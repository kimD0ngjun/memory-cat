 ...
 *
 */
// out 패키지 생성 : javac -d out/production/classes src/main/java/**/*.java
// 실행 : java -cp out/production/classes MemoryCatApplication
// 한번에 실행 : javac -d out/production/classes src/main/java/**/*.java && java -cp out/production/classes MemoryCatApplication
